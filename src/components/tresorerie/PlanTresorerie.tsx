    ...
    <div className="space-y-6">
            ...
            <Table>
              ...
              <TableBody>
                    ...
                    return (
                      <TableRow key={compte.id}>
                        ...
                        <TableCell className="text-right font-mono">
                          {formatCurrency(compte.solde_initial)}
                        </TableCell>
                ...
                <TableRow className="bg-muted/50 font-bold">
                  ...
                  <TableCell className="text-right font-mono">
                    {formatCurrency(stats.data?.soldeTotal || 0)}
                  </TableCell>
                  <TableCell />
                </TableRow>
              </TableBody>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Basées sur les ordonnancements validés en attente de règlement
          </CardDescription>
        </CardHeader>
        <CardContent>
          {dashboard.isLoading ? (
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="p-6 rounded-lg border border-destructive/20 bg-destructive/5">
              ...
              <div className="text-3xl font-bold">
                {formatCurrency((stats.data?.soldeTotal || 0) - (dashboard.data?.prevision7j || 0))}
              </div>
            </div>
            <div className="p-6 rounded-lg border border-destructive/20 bg-destructive/5">
              ...
              <div className="text-3xl font-bold">
                {formatCurrency(
                  (stats.data?.soldeTotal || 0) - (dashboard.data?.prevision30j || 0)
                )}
              </div>
            </div>
          </div>
