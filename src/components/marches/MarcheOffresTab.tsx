...
import { Users, Plus, Award, Star, Loader2, Trophy } from 'lucide-react';
...
export function MarcheOffresTab({ marcheId, canEdit = true }: MarcheOffresTabProps) {
  const { offres, offreRetenue, isLoading, createOffre, selectWinner, isCreating, isSelecting } =
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Prestataires consultés et évaluation des offres</CardDescription>
          </div>
                ...
                <div className="space-y-4">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setFormData((prev) => ({
                          ...
                          nom_fournisseur:
                            prestataires.find((p) => p.id === v)?.raison_sociale || '',
                        }))
                      }
                    >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({ ...prev, nom_fournisseur: e.target.value }))
                      }
                      className="mt-1.5"
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            montant_offre: parseFloat(e.target.value) || 0,
                          }))
                        }
                        className="mt-1.5"
                        min={0}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            delai_execution: parseInt(e.target.value) || 0,
                          }))
                        }
                        className="mt-1.5"
                        min={0}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            note_technique: parseFloat(e.target.value) || 0,
                          }))
                        }
                        className="mt-1.5"
                        min={0}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData((prev) => ({
                            ...prev,
                            note_financiere: parseFloat(e.target.value) || 0,
                          }))
                        }
                        className="mt-1.5"
                        min={0}
          ...
          <div className="text-center py-12 text-muted-foreground">
            ...
            {canEdit && (
              <p className="text-sm mt-2">
                Cliquez sur "Ajouter une offre" pour saisir les offres reçues
              </p>
            )}
          </div>
        ) : (
            ...
            <Table>
              ...
              <TableBody>
                {offres.map((offre) => (
                  <TableRow
                    key={offre.id}
                    className={offre.est_retenu ? 'bg-green-50 dark:bg-green-950/20' : ''}
                  >
                    <TableCell>
                    ...
                    <TableCell className="text-center">{offre.note_technique ?? '-'}</TableCell>
                    <TableCell className="text-center">{offre.note_financiere ?? '-'}</TableCell>
                    <TableCell className="text-center">
                      {offre.note_globale ? (
