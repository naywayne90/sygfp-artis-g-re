          ...
          <div className="flex items-center justify-between gap-2">
            {ETAPES_CHAINE_DEPENSE.map((_, i) => (
              <div key={i} className="flex items-center flex-1">
                ...
                {i < ETAPES_CHAINE_DEPENSE.length - 1 && (
                    ...
                    <TooltipContent side="bottom" className="max-w-xs">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Statut: {
                            stepData?.status === "completed" ? "Validé" :
                            stepData?.status === "current" ? "En cours" :
                            stepData?.status === "rejected" ? "Rejeté" :
                            stepData?.status === "deferred" ? "Différé" :
                            "En attente"
                          }
                        </p>
                        {stepData?.reference && (
                        ...
                        {stepData?.date && (
                          <p className="text-xs">
                            Date: {format(new Date(stepData.date), "dd/MM/yyyy HH:mm", { locale: fr })}
                          </p>
                        )}
