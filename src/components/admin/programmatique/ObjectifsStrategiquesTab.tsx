            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  placeholder="Développer les infrastructures numériques"
                />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 flex gap-2 items-center">
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, annee_debut: parseInt(e.target.value) })}
                    className="w-24"
                  />
                  <span>à</span>
                  <Input
                    ...
                    onChange={(e) => setFormData({ ...formData, annee_fin: parseInt(e.target.value) })}
                    className="w-24"
                  />
                </div>
              </div>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-1">
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          onClick={() => toggleActiveMutation.mutate({ id: item.id, est_actif: !item.est_actif })}
                        >
                          {item.est_actif ? (
