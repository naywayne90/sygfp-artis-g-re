    ...
    <div className="space-y-6">
      ...
      <div className="border-t pt-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <p className="text-sm text-muted-foreground">Code Admission</p>
            <p className="font-mono">{prestataire.code_admission || '-'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t pt-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm text-muted-foreground">Expiration attestation fiscale</p>
            <p>
              {prestataire.date_expiration_fiscale
                ? new Date(prestataire.date_expiration_fiscale).toLocaleDateString('fr-FR')
                : '-'}
            </p>
          </div>
        </div>
