/**
 * Navigation horizontale chaîne de dépense : Passation ↔ Engagement ↔ Liquidation
 * Affiche les liens cliquables entre les étapes liées à un engagement.
 */
...
import { buildChainSteps, type ChainStep } from '@/lib/engagement/engagementChainSteps';
...
interface EngagementChainNavProps {
  engagement: Engagement;
  onCloseDialog?: () => void;
}

export function EngagementChainNav({ engagement, onCloseDialog }: EngagementChainNavProps) {
  const navigate = useNavigate();

  const steps = buildChainSteps(engagement);
