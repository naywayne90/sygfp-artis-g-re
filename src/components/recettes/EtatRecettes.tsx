...
export function EtatRecettes() {
  ...
  const encaissePeriode = filteredRecettes
    .filter((r) => r.statut === 'encaissee')
    .reduce((sum, r) => sum + r.montant, 0);
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="text-2xl font-bold">{formatCurrency(totalPeriode)}</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
            <div className="text-sm text-muted-foreground">Encaissé</div>
            <div className="text-2xl font-bold text-success">{formatCurrency(encaissePeriode)}</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-6">
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow className="bg-muted/50 font-bold">
                ...
                <TableCell className="text-right">{formatCurrency(totalPeriode)}</TableCell>
                <TableCell className="text-right text-success">
                  {formatCurrency(encaissePeriode)}
                </TableCell>
