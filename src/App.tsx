...
const NoteCanvasPage = lazy(() => import('./pages/NoteCanvasPage'));
...
const NotificationsBudgetaires = lazy(
  () => import('./pages/planification/NotificationsBudgetaires')
);
...
const RoadmapDashboard = lazy(() => import('./pages/planification/RoadmapDashboard'));
...
const EtatExecutionTachesPage = lazy(
  () => import('./pages/gestion-taches/EtatExecutionTachesPage')
);
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route element={<LayoutWrapper />}>
                ...
                <Route
                  path="/admin/parametres-programmatiques"
                  element={<ParametresProgrammatiques />}
                />
                ...
                <Route
                  path="/planification/documentation-import"
                  element={<DocumentationImport />}
                />
                ...
                <Route
                  path="/planification/soumissions-feuilles-route"
                  element={<RoadmapSubmissionsPage />}
                />
                ...
                <Route
                  path="/planification/maj-feuilles-route"
                  element={<MajFeuillesRoutePage />}
                />
                <Route
                  path="/gestion-taches/etat-execution"
                  element={<EtatExecutionTachesPage />}
                />
                ...
                <Route path="/espace-direction/notes/:id/canvas" element={<NoteCanvasPage />} />
                ...
                <Route
                  path="/tresorerie/approvisionnements/banque"
                  element={<ApprovisionnementsBanque />}
                />
                <Route
                  path="/tresorerie/approvisionnements/caisse"
                  element={<ApprovisionnementsCaisse />}
                />
                ...
                <Route
                  path="/budget/reamenagements-imputations"
                  element={<ReamenementsImputations />}
                />
