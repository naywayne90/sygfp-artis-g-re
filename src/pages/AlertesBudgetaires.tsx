  ...
  return (
    <Card
      className={cn(
        'transition-all',
        colors.border,
        !alert.acknowledged_at && 'ring-2 ring-offset-2',
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        description="Suivi des seuils et alertes budgétaires"
        icon={Target}
        backUrl="/"
      >
        <Button onClick={() => checkAlerts.mutate()} disabled={checkAlerts.isPending}>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium">
                            {rule.description || `Seuil à ${rule.seuil_pct}%`}
                          </p>
