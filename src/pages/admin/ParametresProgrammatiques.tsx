...
export default function ParametresProgrammatiques() {
  ...
  const activeTab = urlTab && VALID_TABS.has(urlTab) ? urlTab : 'objectifs';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Gérez la structure programmatique, les nomenclatures et les fournisseurs. Import/Export
          disponible pour chaque référentiel.
        </p>
      </div>
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <p className="text-sm text-muted-foreground">
                La structure programmatique organise le budget selon une hiérarchie logique
                permettant de lier les dépenses aux objectifs stratégiques de l'organisation. Chaque
                niveau doit être correctement configuré pour que les lignes budgétaires puissent
                être créées.
              </p>
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border p-4 space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1.5">
                <li>
                  <strong>OS (Objectifs Stratégiques)</strong> : Objectifs à long terme de
                  l'organisation (ex: 2026-2030)
                </li>
                <li>
                  <strong>Missions</strong> : Grandes orientations rattachées aux OS
                </li>
                <li>
                  <strong>Actions</strong> : Déclinaisons opérationnelles des missions
                </li>
                <li>
                  <strong>Activités</strong> : Regroupement de tâches pour réaliser une action
                </li>
                <li>
                  <strong>Sous-Activités</strong> : Niveau de détail supplémentaire
                </li>
                <li>
                  <strong>Tâches</strong> : Opérations concrètes à exécuter
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-lg border p-4 space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1.5">
                <li>
                  <strong>Directions</strong> : Services/départements responsables des lignes
                  budgétaires
                </li>
                <li>
                  <strong>NBE (Nomenclature Budgétaire)</strong> : Classification des natures de
                  dépenses
                </li>
                <li>
                  <strong>SYSCO (Plan Comptable)</strong> : Comptes comptables pour l'imputation
                </li>
                <li>
                  <strong>Prestataires</strong> : Fournisseurs et partenaires de l'organisation
                </li>
              </ul>
            </div>
          </div>
          ...
          <Alert className="bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-800">
            ...
            <AlertDescription className="text-amber-800 dark:text-amber-200">
              ...
              <ul className="text-sm mt-1 space-y-1">
                <li>
                  • <strong>Import/Export</strong> : Chaque onglet dispose d'un bouton pour importer
                  depuis Excel ou exporter les données
                </li>
                <li>
                  • <strong>Ordre de création</strong> : Commencez par les OS, puis les Missions,
                  Actions, etc. (ordre hiérarchique)
                </li>
                <li>
                  • <strong>Liaisons</strong> : Chaque niveau est lié au niveau supérieur (une
                  Action appartient à une Mission)
                </li>
                <li>
                  • <strong>Impact</strong> : Ces référentiels sont utilisés lors de la création des
                  lignes budgétaires dans <strong>Planification → Planification Budgétaire</strong>
                </li>
              </ul>
            </AlertDescription>
          </Alert>
