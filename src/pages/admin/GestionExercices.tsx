  ...
  return (
    <div className="space-y-6">
          ...
          <Card className="border-primary/20 bg-primary/5">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg">
                <HelpCircle className="h-5 w-5 text-primary" />À propos de ce module
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">
                  Un exercice budgétaire représente une année fiscale de gestion. Il définit la
                  période pendant laquelle le budget est planifié, exécuté et suivi. Chaque exercice
                  contient les lignes budgétaires, les engagements, liquidations et paiements
                  associés à cette année.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-muted-foreground space-y-1">
                    <li>
                      • <strong>Total exercices</strong> : Nombre d'exercices créés dans le système
                    </li>
                    <li>
                      • <strong>Exercice actif</strong> : L'année de l'exercice actuellement en
                      cours d'exécution
                    </li>
                    <li>
                      • <strong>Budgets validés</strong> : Exercices dont le budget a été
                      officiellement validé
                    </li>
                    <li>
                      • <strong>En attente</strong> : Exercices ouverts mais non encore validés
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-muted-foreground space-y-1">
                    <li>
                      • <strong>Ouvert</strong> : L'exercice est créé, le budget peut être préparé
                    </li>
                    <li>
                      • <strong>En cours</strong> : L'exercice est actif, les opérations peuvent
                      être effectuées
                    </li>
                    <li>
                      • <strong>Clôturé</strong> : L'exercice est terminé, plus de nouvelles
                      opérations
                    </li>
                    <li>
                      • <strong>Archivé</strong> : L'exercice est archivé pour consultation
                      uniquement
                    </li>
                  </ul>
                </div>
              ...
              <div>
                ...
                <ul className="text-muted-foreground space-y-1">
                  <li>
                    • <strong>Nouvel exercice</strong> : Créer un nouvel exercice pour une année
                    donnée
                  </li>
                  <li>
                    • <strong>Assistant d'initialisation</strong> : Importer les lignes budgétaires
                    depuis un fichier Excel
                  </li>
                  <li>
                    • <strong>Modifier</strong> : Changer le statut ou les dates d'un exercice
                    existant
                  </li>
                  <li>
                    • <strong>Actif/Inactif</strong> : Activer ou désactiver l'accès à un exercice
                  </li>
                </ul>
              </div>

              <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded-lg border border-amber-200 dark:border-amber-800">
                <h4 className="font-semibold mb-1 text-amber-700 dark:text-amber-400">
                  💡 Bon à savoir
                </h4>
                <p className="text-muted-foreground">
                  Un seul exercice peut être "En cours" à la fois. Le budget doit être validé avant
                  de pouvoir effectuer des engagements. Les exercices clôturés restent consultables
                  mais ne permettent plus de nouvelles opérations.
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{editingExercice ? "Modifier l'exercice" : 'Nouvel exercice'}</DialogTitle>
          </DialogHeader>
