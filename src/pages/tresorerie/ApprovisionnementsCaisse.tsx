/**
 * Page Approvisionnements Caisse
 * Gestion des approvisionnements des caisses
 */
...
export default function ApprovisionnementsCaisse() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      {/* Header */}
      <PageHeader
        title="Approvisionnements Caisse"
        description="Gestion des approvisionnements de la caisse"
        icon={Wallet}
        backUrl="/tresorerie"
      >
        ...
        {!isReadOnly && (
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-lg">
              <DialogHeader>
                <DialogTitle>Nouvel approvisionnement caisse</DialogTitle>
                <DialogDescription>
                  Enregistrer une entrée de fonds dans une caisse
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={isCreating || !formData.caisse_id || !formData.montant}
                >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">
              Caisses approvisionnées
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">{caissesActives?.length || 0}</p>
          </CardContent>
        </Card>
      </div>
                ...
                {approvisionnements?.length === 0 ? (
                  ...
                  approvisionnements?.map((appro) => (
                    <TableRow key={appro.id}>
                      ...
                      <TableCell>
                        <div>
                          <p className="font-medium">{appro.caisse?.code}</p>
                          <p className="text-xs text-muted-foreground">{appro.caisse?.libelle}</p>
                        </div>
                      </TableCell>
                      <TableCell>
