  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="page-header">
        ...
        <p className="page-description">Gestion des recettes budgétaires - Exercice {exercice}</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(stats.data?.totalRecettes || 0)}
            </div>
            <p className="text-xs text-muted-foreground">
              {stats.data?.nbRecettes || 0} déclarations
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-success">
              {formatCurrency(stats.data?.totalEncaisse || 0)}
            </div>
            <p className="text-xs text-muted-foreground">
              {stats.data?.nbEncaissees || 0} encaissées
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {(stats.data?.tauxRecouvrement || 0).toFixed(1)}%
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency((stats.data?.totalRecettes || 0) - (stats.data?.totalEncaisse || 0))}
            </div>
