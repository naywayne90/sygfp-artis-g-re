/**
 * AdminDashboardFallback - Dashboard complet avec tous les onglets
 * Utilisé uniquement par les ADMIN pour le débogage et l'accès complet
 */
...
const DASHBOARD_TABS = [
  ...
  { id: 'sdpm', label: 'SDPM', icon: ShoppingCart, roles: ['SDPM', 'ADMIN'] },
  {
    ...
    label: 'Trésorerie',
    icon: Banknote,
    roles: ['TRESORERIE', 'COMPTABILITE', 'ADMIN'],
  },
];
...
export function AdminDashboardFallback() {
  ...
  // Tous les tabs sont accessibles pour admin
  const accessibleTabs = DASHBOARD_TABS.filter(
    (tab) => tab.roles.length === 0 || hasAnyRole(tab.roles)
  );
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Alert className="border-purple-200 bg-purple-50/50 dark:bg-purple-950/20">
        ...
        <AlertDescription className="text-purple-700 dark:text-purple-300">
          <strong>Mode Administrateur</strong> - Vous avez accès à tous les onglets et
            ...
            <CardContent className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">
                  Le <strong>tableau de bord</strong> est votre point d'entrée central dans SYGFP.
                  Il vous offre une vue synthétique de l'exécution budgétaire de l'ARTI, avec des
                  indicateurs clés, des raccourcis vers les actions fréquentes et un suivi en temps
                  réel de la chaîne de dépense.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <ul className="text-muted-foreground space-y-1 ml-6 list-disc">
                    <li>
                      <strong>Notes</strong> : Demandes d'autorisation de dépense en attente
                    </li>
                    <li>
                      <strong>Marchés</strong> : Procédures de passation en cours
                    </li>
                    <li>
                      <strong>Engagements</strong> : Réservations budgétaires actives
                    </li>
                    <li>
                      <strong>Liquidations</strong> : Factures à traiter après service fait
                    </li>
                    <li>
                      <strong>Ordonnancements</strong> : Ordres de paiement en signature
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-muted-foreground space-y-1 ml-6 list-disc">
                    <li>
                      <strong>Note AEF</strong> : Créer une autorisation d'engagement financier
                    </li>
                    <li>
                      <strong>Note SEF</strong> : Créer une dépense sans engagement préalable
                    </li>
                    <li>
                      <strong>Notes à valider</strong> : Accéder aux notes en attente de visa
                    </li>
                    <li>
                      <strong>Engagements à valider</strong> : Traiter les engagements soumis
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-muted-foreground space-y-1 ml-6 list-disc">
                    <li>
                      <strong>Taux d'engagement</strong> : % du budget réservé pour des dépenses
                    </li>
                    <li>
                      <strong>Taux de liquidation</strong> : % des engagements facturés
                    </li>
                    <li>
                      <strong>Taux de paiement</strong> : % des liquidations payées
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-muted-foreground space-y-1 ml-6 list-disc">
                    <li>
                      Accédez au module <strong>Recherche Dossier</strong> dans le menu
                    </li>
              ...
              <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg p-3">
                ...
                <p className="text-amber-600 dark:text-amber-400 text-sm">
                  Chaque dépense suit un processus réglementaire :{' '}
                  <strong>
                    Note (autorisation) → Engagement (réservation budget) → Liquidation (constat
                    service fait) → Ordonnancement (ordre de payer) → Règlement (paiement effectif)
                  </strong>
              ...
              <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg p-3">
                ...
                <p className="text-green-600 dark:text-green-400 text-sm">
                  Les onglets ci-dessous s'adaptent à votre profil. Chaque rôle (DG, DAF, SDPM,
                  Trésorerie) dispose d'une vue personnalisée avec les indicateurs et actions qui
                  lui sont propres.
                </p>
              </div>
            </CardContent>
      ...
      <Tabs defaultValue={getDefaultTab()} className="space-y-6">
        ...
        <TabsContent value="general" className="space-y-6">
          ...
          {!statsLoading && stats?.hasInconsistency && (
            ...
            >
              <AlertTriangle
                className={`h-4 w-4 ${stats.inconsistencyType === 'overspent' ? 'text-destructive' : 'text-warning'}`}
              />
          ...
          {!statsLoading && stats && !stats.isBudgetLoaded && !stats.hasInconsistency && (
            <Alert variant="default" className="border-warning/50 bg-warning/10">
              ...
              <AlertDescription className="flex items-center justify-between">
                <span>
                  Budget non chargé pour l'exercice {exercice}. Les indicateurs financiers affichent
                  0.
                </span>
                <Link to="/planification/budget">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Taux d'exécution global du budget</CardDescription>
              </CardHeader>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-bold text-secondary">
                            {stats?.tauxLiquidation || 0}%
                          </span>
                        </div>
                        <Progress
                          value={stats?.tauxLiquidation || 0}
                    ...
                    <div className="grid gap-4 md:grid-cols-5">
                      <div className="space-y-1 p-4 rounded-lg bg-muted/50">
                        ...
                        <p className="text-xl font-bold">
                          {formatMontant(stats?.budgetTotal || 0)}
                        </p>
                      ...
                      <div className="space-y-1 p-4 rounded-lg bg-primary/10">
                        ...
                        <p className="text-xl font-bold text-primary">
                          {formatMontant(stats?.budgetEngage || 0)}
                        </p>
                      ...
                      <div className="space-y-1 p-4 rounded-lg bg-secondary/10">
                        ...
                        <p className="text-xl font-bold text-secondary">
                          {formatMontant(stats?.budgetLiquide || 0)}
                        </p>
                        <p className="text-xs text-secondary/60">
                          {stats?.tauxLiquidation || 0}% de l'engagé
                        </p>
                      </div>
                      <div className="space-y-1 p-4 rounded-lg bg-success/10">
                        <p className="text-xs text-muted-foreground">Payé</p>
                        <p className="text-xl font-bold text-success">
                          {formatMontant(stats?.budgetPaye || 0)}
                        </p>
                        <p className="text-xs text-success/60">
                          {stats?.tauxPaiement || 0}% du liquidé
                        </p>
                      </div>
                      <div
