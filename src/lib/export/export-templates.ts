...
// ============================================================================
// Templates Imputations
// ============================================================================

export const imputationsTemplates: ExportTemplate[] = [
  {
    id: 'imputations_complet',
    name: 'Export complet',
    module: 'imputations',
    description: 'Toutes les colonnes disponibles',
    columns: [
      ...
      { key: 'statut', label: 'Statut', type: 'text', format: formatters.status, width: 12 },
      { key: 'direction.sigle', label: 'Direction', type: 'text', width: 10 },
      { key: 'note_aef.numero', label: 'NAEF', type: 'text', width: 18 },
      { key: 'budget_line.code', label: 'Ligne budgétaire', type: 'text', width: 20 },
      { key: 'code_imputation', label: 'Code imputation', type: 'text', width: 25 },
      { key: 'source_financement', label: 'Source', type: 'text', width: 12 },
      { key: 'created_at', label: 'Créée le', type: 'date', width: 12 },
      { key: 'validated_at', label: 'Validée le', type: 'date', width: 12 },
      { key: 'commentaire', label: 'Commentaire', type: 'text', width: 30 },
    ],
  },
  {
    id: 'imputations_validation',
    name: 'Pour validation',
    module: 'imputations',
    description: 'Imputations en attente de validation',
    defaultFilters: { statut: 'a_valider' },
    columns: [
      { key: 'reference', label: 'Référence', type: 'text', width: 18 },
      { key: 'objet', label: 'Objet', type: 'text', width: 40 },
      { key: 'montant', label: 'Montant', type: 'currency', width: 15 },
      { key: 'direction.sigle', label: 'Direction', type: 'text', width: 10 },
      { key: 'note_aef.numero', label: 'NAEF', type: 'text', width: 18 },
      { key: 'budget_line.code', label: 'Ligne budget', type: 'text', width: 20 },
      { key: 'created_at', label: 'Date', type: 'date', width: 12 },
    ],
  },
];
...
export const exportTemplatesRegistry: Record<string, ExportTemplate[]> = {
  ...
  imputations: imputationsTemplates,
